...
class ImageWgsHandler:
    def __init__(self, map_path, csv_path):
...
if __name__ == "__main__":
    ...
    map_path="../map/high_res_full_UPB_hybrid.jpg"
    csv_path="../map/high_res_full_UPB_hybrid.csv"

    map_viewer = ImageWgsHandler(map_path, csv_path)

    with open(os.path.join("/home/robert/PycharmProjects/upb_dataset/ffa9aefae8a34091.json")) as f:
        info = json.load(f)
